...
public class FloatDoubleConcurrentChainedMapTest extends TestCase
{
    ...
    protected IFloatDoubleConcurrentMap getMap( final int size, final float ff )
    {
        return FloatMapFactory.concurrentFloatDoubleMap( size, ff );
    }
    ...
    private void testPutHelper( final int threads, final float ff ) throws InterruptedException {
        ...
        final IFloatDoubleConcurrentMap map = getMap( INITIAL_CAPACITY, ff );
    ...
    private static class Adder implements Runnable
    {
        ...
        private final IFloatDoubleConcurrentMap m_map;

        public Adder( float from, float to, CountDownLatch startGate, CountDownLatch endGate, IFloatDoubleConcurrentMap map ) {
            m_from = from;
            m_to = to;
    ...
    private static class Updater implements Runnable
    {
        ...
        public Updater( float from, float to, CountDownLatch startGate, CountDownLatch endGate, IFloatDoubleConcurrentMap map ) {
            m_from = from;
            m_to = to;
            m_startGate = startGate;
            m_endGate = endGate;
    ...
    private static class AddUpdateRemover implements Runnable
    {
        ...
        public AddUpdateRemover( float from, float to, CountDownLatch startGate, CountDownLatch endGate, IFloatDoubleConcurrentMap map ) {
            m_from = from;
            m_to = to;
            m_startGate = startGate;
            m_endGate = endGate;
    ...
    private static class Remover implements Runnable
    {
        ...
        public Remover( float from, float to, CountDownLatch startGate, CountDownLatch endGate, IFloatDoubleConcurrentMap map ) {
            m_from = from;
            m_to = to;
            m_startGate = startGate;
            m_endGate = endGate;
