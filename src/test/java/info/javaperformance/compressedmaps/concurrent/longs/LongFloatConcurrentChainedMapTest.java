...
public class LongFloatConcurrentChainedMapTest extends TestCase
{
    ...
    protected ILongFloatConcurrentMap getMap( final int size, final float ff )
    {
        return LongMapFactory.concurrentLongFloatMap( size, ff );
    }
    ...
    private void testPutHelper( final int threads, final float ff ) throws InterruptedException {
        ...
        final ILongFloatConcurrentMap map = getMap( INITIAL_CAPACITY, ff );
    ...
    private static class Adder implements Runnable
    {
        ...
        private final ILongFloatConcurrentMap m_map;

        public Adder( long from, long to, CountDownLatch startGate, CountDownLatch endGate, ILongFloatConcurrentMap map ) {
            m_from = from;
            m_to = to;
    ...
    private static class Updater implements Runnable
    {
        ...
        public Updater( long from, long to, CountDownLatch startGate, CountDownLatch endGate, ILongFloatConcurrentMap map ) {
            m_from = from;
            m_to = to;
            m_startGate = startGate;
            m_endGate = endGate;
    ...
    private static class AddUpdateRemover implements Runnable
    {
        ...
        public AddUpdateRemover( long from, long to, CountDownLatch startGate, CountDownLatch endGate, ILongFloatConcurrentMap map ) {
            m_from = from;
            m_to = to;
            m_startGate = startGate;
            m_endGate = endGate;
    ...
    private static class Remover implements Runnable
    {
        ...
        public Remover( long from, long to, CountDownLatch startGate, CountDownLatch endGate, ILongFloatConcurrentMap map ) {
            m_from = from;
            m_to = to;
            m_startGate = startGate;
            m_endGate = endGate;
