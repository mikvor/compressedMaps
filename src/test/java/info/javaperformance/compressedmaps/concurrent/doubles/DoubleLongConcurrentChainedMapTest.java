...
public class DoubleLongConcurrentChainedMapTest extends TestCase
{
    ...
    protected IDoubleLongConcurrentMap getMap( final int size, final float ff )
    {
        return DoubleMapFactory.concurrentDoubleLongMap( size, ff );
    }
    ...
    private void testPutHelper( final int threads, final float ff ) throws InterruptedException {
        ...
        final IDoubleLongConcurrentMap map = getMap( INITIAL_CAPACITY, ff );
    ...
    private static class Adder implements Runnable
    {
        ...
        private final IDoubleLongConcurrentMap m_map;

        public Adder( double from, double to, CountDownLatch startGate, CountDownLatch endGate, IDoubleLongConcurrentMap map ) {
            m_from = from;
            m_to = to;
    ...
    private static class Updater implements Runnable
    {
        ...
        public Updater( double from, double to, CountDownLatch startGate, CountDownLatch endGate, IDoubleLongConcurrentMap map ) {
            m_from = from;
            m_to = to;
            m_startGate = startGate;
            m_endGate = endGate;
    ...
    private static class AddUpdateRemover implements Runnable
    {
        ...
        public AddUpdateRemover( double from, double to, CountDownLatch startGate, CountDownLatch endGate, IDoubleLongConcurrentMap map ) {
            m_from = from;
            m_to = to;
            m_startGate = startGate;
            m_endGate = endGate;
    ...
    private static class Remover implements Runnable
    {
        ...
        public Remover( double from, double to, CountDownLatch startGate, CountDownLatch endGate, IDoubleLongConcurrentMap map ) {
            m_from = from;
            m_to = to;
            m_startGate = startGate;
            m_endGate = endGate;
