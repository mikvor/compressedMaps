...
public class DoubleDoubleConcurrentChainedMap implements IDoubleDoubleConcurrentMap
{
     ...
     */
    public DoubleDoubleConcurrentChainedMap( final long size, float fillFactor )
    {
        this( size, fillFactor, DefaultDoubleSerializer.INSTANCE, DefaultDoubleSerializer.INSTANCE );
    }
