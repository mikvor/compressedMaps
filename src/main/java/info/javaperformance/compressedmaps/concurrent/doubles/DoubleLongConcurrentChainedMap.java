...
public class DoubleLongConcurrentChainedMap implements IDoubleLongConcurrentMap
{
     ...
     */
    public DoubleLongConcurrentChainedMap( final long size, float fillFactor )
    {
        this( size, fillFactor, DefaultDoubleSerializer.INSTANCE, DefaultLongSerializer.INSTANCE );
    }
