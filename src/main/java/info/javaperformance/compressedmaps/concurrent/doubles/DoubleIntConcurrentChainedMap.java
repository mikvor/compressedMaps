...
public class DoubleIntConcurrentChainedMap implements IDoubleIntConcurrentMap
{
     ...
     */
    public DoubleIntConcurrentChainedMap( final long size, float fillFactor )
    {
        this( size, fillFactor, DefaultDoubleSerializer.INSTANCE, DefaultIntSerializer.INSTANCE );
    }
