...
public class DoubleFloatConcurrentChainedMap implements IDoubleFloatConcurrentMap
{
     ...
     */
    public DoubleFloatConcurrentChainedMap( final long size, float fillFactor )
    {
        this( size, fillFactor, DefaultDoubleSerializer.INSTANCE, DefaultFloatSerializer.INSTANCE );
    }
