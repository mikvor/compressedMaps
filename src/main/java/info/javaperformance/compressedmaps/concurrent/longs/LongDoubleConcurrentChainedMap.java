...
public class LongDoubleConcurrentChainedMap implements ILongDoubleConcurrentMap
{
     ...
     */
    public LongDoubleConcurrentChainedMap( final long size, float fillFactor )
    {
        this( size, fillFactor, DefaultLongSerializer.INSTANCE, DefaultDoubleSerializer.INSTANCE );
    }
