...
public class LongFloatConcurrentChainedMap implements ILongFloatConcurrentMap
{
     ...
     */
    public LongFloatConcurrentChainedMap( final long size, float fillFactor )
    {
        this( size, fillFactor, DefaultLongSerializer.INSTANCE, DefaultFloatSerializer.INSTANCE );
    }
