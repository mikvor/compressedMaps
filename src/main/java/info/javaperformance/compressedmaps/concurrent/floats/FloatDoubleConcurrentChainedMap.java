...
public class FloatDoubleConcurrentChainedMap implements IFloatDoubleConcurrentMap
{
     ...
     */
    public FloatDoubleConcurrentChainedMap( final long size, float fillFactor )
    {
        this( size, fillFactor, DefaultFloatSerializer.INSTANCE, DefaultDoubleSerializer.INSTANCE );
    }
