...
public class FloatLongConcurrentChainedMap implements IFloatLongConcurrentMap
{
     ...
     */
    public FloatLongConcurrentChainedMap( final long size, float fillFactor )
    {
        this( size, fillFactor, DefaultFloatSerializer.INSTANCE, DefaultLongSerializer.INSTANCE );
    }
