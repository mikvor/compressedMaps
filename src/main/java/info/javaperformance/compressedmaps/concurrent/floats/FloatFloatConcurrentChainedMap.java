...
public class FloatFloatConcurrentChainedMap implements IFloatFloatConcurrentMap
{
     ...
     */
    public FloatFloatConcurrentChainedMap( final long size, float fillFactor )
    {
        this( size, fillFactor, DefaultFloatSerializer.INSTANCE, DefaultFloatSerializer.INSTANCE );
    }
