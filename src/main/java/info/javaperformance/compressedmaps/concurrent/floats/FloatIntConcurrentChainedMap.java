...
public class FloatIntConcurrentChainedMap implements IFloatIntConcurrentMap
{
     ...
     */
    public FloatIntConcurrentChainedMap( final long size, float fillFactor )
    {
        this( size, fillFactor, DefaultFloatSerializer.INSTANCE, DefaultIntSerializer.INSTANCE );
    }
