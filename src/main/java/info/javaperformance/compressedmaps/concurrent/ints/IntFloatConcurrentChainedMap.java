...
public class IntFloatConcurrentChainedMap implements IIntFloatConcurrentMap
{
     ...
     */
    public IntFloatConcurrentChainedMap( final long size, float fillFactor )
    {
        this( size, fillFactor, DefaultIntSerializer.INSTANCE, DefaultFloatSerializer.INSTANCE );
    }
