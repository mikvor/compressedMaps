...
public class FloatDoubleChainedMap implements IFloatDoubleMap
{
     ...
     */
    public FloatDoubleChainedMap( final long size, float fillFactor )
    {
        this( size, fillFactor, DefaultFloatSerializer.INSTANCE, DefaultDoubleSerializer.INSTANCE, SingleThreadedBlockAllocator.DEFAULT_RECYCLE_BOUND );
    }
