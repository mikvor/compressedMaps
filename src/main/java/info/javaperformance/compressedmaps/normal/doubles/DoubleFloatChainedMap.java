...
public class DoubleFloatChainedMap implements IDoubleFloatMap
{
     ...
     */
    public DoubleFloatChainedMap( final long size, float fillFactor )
    {
        this( size, fillFactor, DefaultDoubleSerializer.INSTANCE, DefaultFloatSerializer.INSTANCE, SingleThreadedBlockAllocator.DEFAULT_RECYCLE_BOUND );
    }
