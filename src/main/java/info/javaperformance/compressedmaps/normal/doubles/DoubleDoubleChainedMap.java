...
public class DoubleDoubleChainedMap implements IDoubleDoubleMap
{
     ...
     */
    public DoubleDoubleChainedMap( final long size, float fillFactor )
    {
        this( size, fillFactor, DefaultDoubleSerializer.INSTANCE, DefaultDoubleSerializer.INSTANCE, SingleThreadedBlockAllocator.DEFAULT_RECYCLE_BOUND );
    }
