...
public class DoubleLongChainedMap implements IDoubleLongMap
{
     ...
     */
    public DoubleLongChainedMap( final long size, float fillFactor )
    {
        this( size, fillFactor, DefaultDoubleSerializer.INSTANCE, DefaultLongSerializer.INSTANCE, SingleThreadedBlockAllocator.DEFAULT_RECYCLE_BOUND );
    }
