 ...
 *
 * TODO:
 * 2) factory class, standard interfaces
 */
public class LongIntChainedMap implements ILongIntMap
{
     ...
     */
    public LongIntChainedMap( final int size, float fillFactor )
    {
     ...
     * @throws IllegalArgumentException If {@code fillFactor > 16}
     */
    public LongIntChainedMap( final int size, final float fillFactor,
     ...
     */
    public void rehash( final Buckets old )
    {
