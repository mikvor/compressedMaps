...
public class LongDoubleChainedMap implements ILongDoubleMap
{
     ...
     */
    public LongDoubleChainedMap( final long size, float fillFactor )
    {
        this( size, fillFactor, DefaultLongSerializer.INSTANCE, DefaultDoubleSerializer.INSTANCE, SingleThreadedBlockAllocator.DEFAULT_RECYCLE_BOUND );
    }
