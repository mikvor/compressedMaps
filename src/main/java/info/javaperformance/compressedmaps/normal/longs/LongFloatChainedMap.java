...
public class LongFloatChainedMap implements ILongFloatMap
{
     ...
     */
    public LongFloatChainedMap( final long size, float fillFactor )
    {
        this( size, fillFactor, DefaultLongSerializer.INSTANCE, DefaultFloatSerializer.INSTANCE, SingleThreadedBlockAllocator.DEFAULT_RECYCLE_BOUND );
    }
