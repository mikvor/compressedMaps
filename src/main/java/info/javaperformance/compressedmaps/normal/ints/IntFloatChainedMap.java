...
public class IntFloatChainedMap implements IIntFloatMap
{
     ...
     */
    public IntFloatChainedMap( final long size, float fillFactor )
    {
        this( size, fillFactor, DefaultIntSerializer.INSTANCE, DefaultFloatSerializer.INSTANCE, SingleThreadedBlockAllocator.DEFAULT_RECYCLE_BOUND );
    }
