...
public class IntDoubleChainedMap implements IIntDoubleMap
{
     ...
     */
    public IntDoubleChainedMap( final long size, float fillFactor )
    {
        this( size, fillFactor, DefaultIntSerializer.INSTANCE, DefaultDoubleSerializer.INSTANCE, SingleThreadedBlockAllocator.DEFAULT_RECYCLE_BOUND );
    }
